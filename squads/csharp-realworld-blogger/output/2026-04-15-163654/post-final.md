...
- Status: approved
- Ajustes aplicados:
  - Reforçado contrato de consistência por classe de dado.
  - Mantido foco em decisão arquitetural, evitando tutorial genérico.
  - Frontmatter validado para publicação Astro.
