...
- Status: approved
- Ajustes aplicados:
  - frontmatter validado para Astro;
  - fechamento reforçado para manter foco em decisão arquitetural e risco residual;
  - terminologia mantida consistente entre CloudWatch Logs, Lambda e triagem operacional.
