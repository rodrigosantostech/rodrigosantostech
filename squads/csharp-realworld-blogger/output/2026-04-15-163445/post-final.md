...
- Status: approved
- Ajustes aplicados:
  - Reforçado o limite do uso de IA para triagem operacional.
  - Adicionada explicitação de trade-off entre consistência e complexidade.
  - Validado frontmatter com campos exigidos pela coleção de blog.
