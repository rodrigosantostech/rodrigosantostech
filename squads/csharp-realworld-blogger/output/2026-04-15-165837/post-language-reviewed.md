...
- Status: approved
- Ajustes aplicados:
  - ortografia e acentuação normalizadas em PT-BR;
  - pontuação refinada para reduzir frases longas;
  - ritmo e transições ajustados sem descaracterizar a voz técnica.
